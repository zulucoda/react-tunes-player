  ...
  describe("when not rendered with tunes", function() {
    beforeEach(function() {
      wrapper = (0, _enzyme.shallow)(
        _react2.default.createElement(_reactTunesPlayerView2.default, {
          setTunes: mockFunc
        })
      );
    });
    ...
    describe("componentDidMount", function() {
      it("should NOT add event listener when tunes props is supplied", function() {
        spyOn(
          _reactTunesPlayerView2.default.prototype,
          "componentDidMount"
        ).and.callThrough();
        ...
        expect(
          _reactTunesPlayerView2.default.prototype.componentDidMount
