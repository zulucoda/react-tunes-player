  ...
  render() {
    return (
      <div className="App">
        ...
        <div>
          <ReactTunesPlayerContainer tunes={[{
            tune: '/assets/audio/the_lego_tune.ogg',
            name: 'The lego tune',
            album: '/assets/images/dune.jpg'
          },{
            tune: 'http://test.ithastobejazz.co.za/mp3s/1.It-Has-To-Be-Jazz-Preview.mp3',
            name: 'It Has To Be Jazz',
            album: 'http://test.ithastobejazz.co.za/images/albums/1.jpg'
          },{
            tune: 'http://test.ithastobejazz.co.za/mp3s/2.Prelude-1-Preview-1.mp3',
            name: 'Prelude',
