      ...
      <TunesInner>
        <TunesWrapper>
          <MainWrapper>
            ...
            <Volume>
              <HighVolume onClick={() => setVolume(HIGH_VOLUME)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <MediumVolume onClick={() => setVolume(MEDIUM_VOLUME)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <LowVolume onClick={() => setVolume(LOW_VOLUME)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <path d="M64 192v128h85.334L256 431.543V80.458L149.334 192H64z" />
                </svg>
              </LowVolume>
              <MuteVolume onClick={() => setVolume(MUTE_VOLUME)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
